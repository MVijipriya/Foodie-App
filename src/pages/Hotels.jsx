...
class Hotels extends React.Component{
    ...
    render(){
        ...
        <div class="hotels">
            {this.state.list.map(
                x => <Restaurant feature_image = {x.feature_image} name = {x.name} cuisines = {x.cuisines}/> 
            )}
        </div>
        </div>
        )
...
{/*             
            <div class="restPic">
                    ...
                    <div class="content-ellipsis">
                        <p><b>Carnivall Restaurant</b><br/>All you can eat - Cosy - Casual</p>
        ...
        <div class="hotels">
                <div class="restPic">
                        <img src="Assets/restaurant.jpeg"/><br/>
                        <div class="content-ellipsis">
                ...
                <div class="restPic">
                        <img src="Assets/restaurant.jpeg"/>
                        <div class="content-ellipsis">
                            <p><b>Shree Narayana Restaurant</b><br/>Cash only.</p>
        ...
        <div class="hotels">
                ...
                <div class="restPic">
                    <img src="Assets/restaurant.jpeg"/>
                    <div class="content-ellipsis">
                        <p><b>Palm Tree Restaurant and Grill</b><br/>Good for Kids.</p>
